                                    ...
                                    <tr className="bg-gray-50">
                                        <td colSpan={7} className="p-4">
                                            <div className="flex gap-3 flex-wrap">
                                                ...
                                                {paper.review_id && (
                                                    <Link 
                                                        href={typeof route === 'function' ? route('reviews.edit', paper.review_id) : '#'}
                                                ...
                                                {paper.review_id && (
                                                    <Link 
                                                        href={typeof route === 'function' ? route('reviews.show', paper.review_id) : '#'}
                                                        className="inline-flex items-center px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded-lg hover:bg-purple-700 transition duration-200 shadow-sm"
                                                    >
                                                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                                ...
                                                <Link 
                                                    href={typeof route === 'function' ? route('review.history', { paper_id: paper.id }) : '#'}

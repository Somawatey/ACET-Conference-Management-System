        ...
        <>
                    ...
                    <nav className="flex-1 flex justify-end gap-2">
                        {auth.user ? (
                            <Link
                                ...
                                className="bg-blue rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[blue] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                            >
                                Dashboard
                            </Link>
                        ) : (
                            <>
                                <button onClick={() => setShowLogin(true)} className='bg-blue rounded-md px-3 py-2 text-white ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[blue] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white hover:bg-green-700 hover:scale-105 ease-in-out duration-300'>
                                    Log in
                                </button>
                                <Link
                                    href={route('register')}
            ...
            <footer class="bg-white dark:bg-gray-900">
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">All Rights Reserved.</span>
